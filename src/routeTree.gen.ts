...
import { Route as errorsNetworkErrorRouteImport } from './routes/(errors)/NetworkError'
...
const errorsNetworkErrorRoute = errorsNetworkErrorRouteImport.update({
...
const AuthenticatedUserManagmentUserRoleIndexRoute =
  AuthenticatedUserManagmentUserRoleIndexRouteImport.update({
    id: '/user-managment/userRole/',
...
export interface FileRoutesByFullPath {
  ...
  '/NetworkError': typeof errorsNetworkErrorRoute
...
export interface FileRoutesById {
  ...
  '/(errors)/NetworkError': typeof errorsNetworkErrorRoute
...
export interface RootRouteChildren {
  ...
  errorsNetworkErrorRoute: typeof errorsNetworkErrorRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/(errors)/NetworkError': {
      ...
      preLoaderRoute: typeof errorsNetworkErrorRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/(errors)/503': {
      id: '/(errors)/503'
    ...
    '/_authenticated/user-managment/userRole/': {
      id: '/_authenticated/user-managment/userRole/'
      path: '/user-managment/userRole'
      fullPath: '/user-managment/userRole'
    ...
    '/_authenticated/masters/vehicleTypes/': {
      ...
      path: '/masters/vehicleTypes'
      fullPath: '/masters/vehicleTypes'
      preLoaderRoute: typeof AuthenticatedMastersVehicleTypesIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
  }
}
...
const rootRouteChildren: RootRouteChildren = {
  ...
  errorsNetworkErrorRoute: errorsNetworkErrorRoute,
}
